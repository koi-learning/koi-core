...
class ModelProxy(Model):
    ...
    def _basic_fields(self, meta) -> ModelBasicFields:
        return self.pool.api.get_model(self.id, meta)

    @_basic_fields.setter
    def _basic_fields(self, value: ModelBasicFields) -> None:
        return self.pool.api.update_model(self.id, value)
    ...
    def code(self, value: Code) -> None:
        self.pool.api.set_model_code(self.id, value.toBytes())

    @property
    @cache
    def request_plugin(self, meta) -> Any:
        return self.pool.api.get_model_request_plugin(self.id, meta)
    ...
    def visual_plugin(self, meta) -> Any:
        return self.pool.api.get_model_visual_plugin(self.id, meta)
