...
def test_offline_model_inference(api_mock):
    ...
    koi_core.init()
    pool = koi_core.create_api_object_pool(
        host="testing://base", username="user", password="password", persistance_file=persistence
    )
    instance: Instance = pool.instance(InstanceId(uuid.UUID("00000000-0001-1000-8000-000000000000"),uuid.UUID("00000000-0002-1000-8000-000000000000")))
    ...
    instance = pool.instance(InstanceId(uuid.UUID("00000000-0001-1000-8000-000000000000"),uuid.UUID("00000000-0002-1000-8000-000000000000")))
    koi_core.control.infer(instance, [], dev=True)
    koi_core.deinit()
...
def test_offline_features_are_persistived():
    ...
    for cls in classes:
      ...
      for feature in features:
        assert strategy.shouldPersist(cls, feature, None)==True, f"Method {feature} of class {cls.__name__} is marked as Offline Feature but is not persitified in ExpireCachingStrategy"
    pass